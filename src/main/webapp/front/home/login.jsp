		...
		<div class="login-banner">
						...
						<div class="login-form">
						  <form>
							   <div class="user-name">
								    ...
								    <input type="text" name="memberName" id="user" placeholder="用户名">
                 </div>
                 <div class="user-pass">
            ...
            <div class="login-links">
                <label for="remember-me"><input id="remember-me" type="checkbox">记住密码</label>
								...
								<div class="am-cf">
									<input type="submit" name="" id = "sub" value="登 录" class="am-btn am-btn-primary am-btn-sm">
								</div>
					 ...
					 $("#sub").click(function(){
						 if($("#user").val()!="" && $("#user").val() !=null){
							 if($("#password").val()!="" && $("#password").val() !=null){
								 $.ajax({
									 type:"post",
									 url:"${pageContext.request.contextPath}/member/logins",
