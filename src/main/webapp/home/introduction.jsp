...
<body>
	...
	<div class="nav white">
		...
		<div class="search-bar pr">
			...
			<form action="${pageContext.request.contextPath}/home/introduction.jsp" method="post">
					...
					<ul class="tb-thumb" id="thumblist">
						<%-- <li class="tb-selected">
							<div class="tb-pic tb-s40">
								<a href="#"><img src="${pageContext.request.contextPath}/images/01_small.jpg"
									mid="${pageContext.request.contextPath}/images/01_mid.jpg" big="${pageContext.request.contextPath}/images/01.jpg"></a>
							</div>
						</li> --%>
				...
				if(json.error_code==0){
					...
					if(details.hasOwnProperty("product_sku_detail")){
						...
						for(var index in skuArray){
							length++;
							if(index==0){
								$("#sku").append('<li class="sku-line selected">'+ skuArray[index]["sku_name"] +'<i></i></li>')
							}else{
								$("#sku").append('<li class="sku-line">'+ skuArray[index]["sku_name"] +'<i></i></li>')
							}
						}
						if(length!=0){
							/* 商品数量选择与库存信息 */
							...
							$("#current_price").append('<dt>促销价</dt>'
									+'<dd>'
									+'<em>¥</em><b class="sys_item_price">'+ skuArray[0]["sku_price"] +'</b>'
									+'</dd>');
						}else{
							$("#stock").append('<input id="min" class="am-btn am-btn-default" name="" type="button" value="-" />'
									+'<input id="text_box" name="" type="text" value="1" style="width:30px;" />'
							...
							$("#current_price").append('<dt>促销价</dt>'
									+'<dd>'
									+'<em>¥</em><b class="sys_item_price">'+ details.current_price +'</b>'
									+'</dd>');
						}
